...
type Exposure struct {
	...
	ExposureType ExposureType      `protobuf:"varint,11,opt,name=exposure_type,json=exposureType,proto3,enum=opensource.tab.cache_server.ExposureType" json:"exposure_type,omitempty"`                                 // ExposureType
	...
	ExtraData    map[string]string `protobuf:"bytes,15,rep,name=extra_data,json=extraData,proto3" json:"extra_data,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // Extended fields
}
...
type Event struct {
	...
	Time      int64             `protobuf:"varint,4,opt,name=time,proto3" json:"time,omitempty"`                                                                                                 // Timestamp, accurate to seconds
	Metadata  map[string]string `protobuf:"bytes,10,rep,name=metadata,proto3" json:"metadata,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // Multiple kv combinations in one log
}
...
type MonitorEvent struct {
	...
	StatusCode MonitorEventStatus `protobuf:"varint,6,opt,name=status_code,json=statusCode,proto3,enum=opensource.tab.cache_server.MonitorEventStatus" json:"status_code,omitempty"`                            // status
	...
	ExtInfo    map[string]string  `protobuf:"bytes,13,rep,name=ext_info,json=extInfo,proto3" json:"ext_info,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // Further information
}
...
var file_event_server_proto_rawDesc = []byte{
	...
	0xe4, 0x93, 0x02, 0x1b, 0x3a, 0x01, 0x2a, 0x22, 0x16, 0x2f, 0x76, 0x31, 0x2f, 0x65, 0x78, 0x70,
	0x6f, 0x73, 0x75, 0x72, 0x65, 0x5f, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x2f, 0x6c, 0x6f, 0x67, 0x12,
	...
	0x6c, 0x6f, 0x67, 0x12, 0x91, 0x01, 0x0a, 0x14, 0x4c, 0x6f, 0x67, 0x4d, 0x6f, 0x6e, 0x69, 0x74,
	...
	0x6e, 0x52, 0x65, 0x73, 0x70, 0x22, 0x20, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x1a, 0x3a, 0x01, 0x2a,
	0x22, 0x15, 0x2f, 0x76, 0x31, 0x2f, 0x6d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x5f, 0x65, 0x76,
	0x65, 0x6e, 0x74, 0x2f, 0x6c, 0x6f, 0x67, 0x42, 0x2e, 0x5a, 0x2c, 0x67, 0x69, 0x74, 0x68, 0x75,
